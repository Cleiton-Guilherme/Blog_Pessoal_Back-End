...
public class UserDetailsServiceImpl implements UserDetailsService{
	...
	@Autowired
	private com.blogpessoal.Repository.UsuarioRepository userRepository;
	...
	public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
		...
		Optional<com.blogpessoal.model.Usuario> usuario = userRepository.findByUsuario(userName);
